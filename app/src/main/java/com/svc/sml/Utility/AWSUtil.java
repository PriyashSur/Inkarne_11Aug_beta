...
public class AWSUtil {
    ...
    private static int timeoutSocket = 180000;
    private static int timeoutConnection = 180000;
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            ...
            */
            ...
            ClientConfiguration confg = new ClientConfiguration();
            confg.setConnectionTimeout(timeoutConnection);
            confg.setSocketTimeout(timeoutSocket);
    ...
    public static TransferUtility getTransferUtility(Context context) {
        if (sTransferUtility == null) {
            sTransferUtility = new TransferUtility(getS3Client(InkarneAppContext.getAppContext()),
                    InkarneAppContext.getAppContext());
        }
    ...
    public static void fillMap(Map<String, Object> map, TransferObserver observer, boolean isChecked) {
        ...
        map.put("progressCumalative", progress);
        map.put("bytes",
