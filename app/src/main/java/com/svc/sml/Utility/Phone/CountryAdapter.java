 ...
 */
package com.svc.sml.Utility.Phone;
...
public class CountryAdapter extends ArrayAdapter<Country> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //ImageView imageView = (ImageView) convertView.findViewById(R.id.tv_telephone_code);
        //imageView.setImageResource(country.getResId());
        TextView tvCode = (TextView) convertView.findViewById(R.id.tv_telephone_code);
        tvCode.setText("+"+country.getCountryCode());
        return convertView;
    }
