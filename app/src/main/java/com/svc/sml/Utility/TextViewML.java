 ...
 */
public class TextViewML extends TextView {

    public TextViewML(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setType(context);
    }

    public TextViewML(Context context, AttributeSet attrs) {
        super(context, attrs);
        setType(context);
    }

    public TextViewML(Context context) {
        super(context);
        setType(context);
    }
