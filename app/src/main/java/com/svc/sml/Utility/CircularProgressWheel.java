...
/**
 * An indicator of progressCumalative, similar to Android's ProgressBar.
 *
 * @author Todd Davies
 *         <p/>
 *         See MIT-LICENSE.txt for licence details
 */
public class CircularProgressWheel extends View {
     ...
     * @param attrs
     */
    public CircularProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.CircularProgressWheel));
    }
     ...
     * draw the progressCumalative wheel
     */
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.CircularProgressWheel_pwBarWidth, barWidth);
        rimWidth = (int) a.getDimension(R.styleable.CircularProgressWheel_pwRimWidth, rimWidth);
        spinSpeed = (int) a.getDimension(R.styleable.CircularProgressWheel_pwSpinSpeed, spinSpeed);
        barLength = (int) a.getDimension(R.styleable.CircularProgressWheel_pwBarLength, barLength);

        delayMillis = a.getInteger(R.styleable.CircularProgressWheel_pwDelayMillis, delayMillis);
        if (delayMillis < 0) { delayMillis = 10; }

        // Only set the text if it is explicitly defined
        if (a.hasValue(R.styleable.CircularProgressWheel_pwText)) {
            setText(a.getString(R.styleable.CircularProgressWheel_pwText));
        }

        barColor = a.getColor(R.styleable.CircularProgressWheel_pwBarColor, barColor);
        textColor = a.getColor(R.styleable.CircularProgressWheel_pwTextColor, textColor);
        rimColor = a.getColor(R.styleable.CircularProgressWheel_pwRimColor, rimColor);
        circleColor = a.getColor(R.styleable.CircularProgressWheel_pwCircleColor, circleColor);
        contourColor = a.getColor(R.styleable.CircularProgressWheel_pwContourColor, contourColor);

        textSize = (int) a.getDimension(R.styleable.CircularProgressWheel_pwTextSize, textSize);
        contourSize = a.getDimension(R.styleable.CircularProgressWheel_pwContourSize, contourSize);
    ...
    */
    ...
    /**
     * Increment the progressCumalative by 1 (of 360)
     */
    ...
    /**
     * Set the progressCumalative to a specific value
     * @param p
     */
    ...
    /**
     * Set the text in the progressCumalative bar
