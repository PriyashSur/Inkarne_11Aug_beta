...
public class FiducialActivity2Final extends FiducialActivity {
...
//    @Override
//    protected void initDrawFedPointsOld() {
//        initFaceItem();
//        //getIntentData();
//        initUserFiducials();
//        //getUserFedPoints();
...
//        transferUtility = AWSUtil.getTransferUtility(FiducialActivity2Final.this);
//        picSource = getIntent().getStringExtra(FaceSelectionActivity.EXTRA_PARAM_PIC_SOURCE_TYPE);
//        awsKeyPathPicUpload = getIntent().getStringExtra(AdjustPicActivity.EXTRA_PARAM_PIC_AWS_KEY_PATH);
...
//        }
        ...
        private void createUploadDialog1() {
            dialogBuilder = new AlertDialog.Builder(FiducialActivity2Final.this);
            LayoutInflater inflater = FiducialActivity2Final.this.getLayoutInflater();
            ...
            adapter = new UploadAdapter(FiducialActivity2Final.this, arrayUploadModel);
            lvUpload.setAdapter(adapter);
            alertDialog = dialogBuilder.create();
            mInflater = (LayoutInflater) FiducialActivity2Final.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
