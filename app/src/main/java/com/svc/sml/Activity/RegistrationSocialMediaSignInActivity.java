...
public class RegistrationSocialMediaSignInActivity extends AppCompatActivity implements OnConnectionFailedListener, ConnectionCallbacks, ResultCallback<LoadPeopleResult> {
    protected GoogleApiClient google_api_client;
    protected GoogleApiAvailability google_api_availability;
    protected SignInButton signIn_btn;
    protected static final int SIGN_IN_CODE = 0;
    protected static final int PROFILE_PIC_SIZE = 120;
    protected ConnectionResult connection_result;
    protected boolean is_intent_inprogress;
    protected boolean is_signInBtn_clicked;
...
//    }
            ...
            Plus.AccountApi.revokeAccessAndDisconnect(google_api_client)
                    .setResultCallback(new ResultCallback<Status>() {
                        ...
                        public void onResult(Status arg0) {
                            Log.d("Gplus", "User access revoked!");
                            buidNewGoogleApiClient();
                            google_api_client.connect();
                            changeUI(false);
                        }
    ...
    protected void setPersonalInfo(Person currentPerson){
...
//        new LoadProfilePic(user_picture).execute(profile_pic);
    ...
    protected void changeUI(boolean signedIn) {
        if (signedIn) {
...
//                }
//                Intent intent = new Intent(RegistrationSocialMediaSignInActivity.this,FriendActivity.class);
