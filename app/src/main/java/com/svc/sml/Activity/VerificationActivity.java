...
import com.svc.sml.Fragments.RegistrationFragment;
...
public class VerificationActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback, VerificationListener {
  ...
  void createVerification(String phoneNumber, boolean skipPermissionCheck, String countryCode) {
    String applicationKey = ConstantsUtil.OTPSecretKey;
    Config config = SendOtpVerification.config().context(getApplicationContext()).applicationKey(applicationKey)
        .build();
  ...
  void initiateVerification() {
    initiateVerification(false);//TODO
  }
  ...
  void initiateVerification(boolean skipPermissionCheck) {
    ...
    if (intent != null) {
      String phoneNumber = intent.getStringExtra(RegistrationFragment.INTENT_PHONENUMBER);
      String countryCode = intent.getStringExtra(RegistrationFragment.INTENT_COUNTRY_CODE);
  ...
  private void launchFaceSelectionActivity() {
    //Intent myIntent = new Intent(this, FaceSelectionActivity.class);
    Intent myIntent = new Intent(this, BodyMeasurementActivity.class);
